...
| 챕터 | 제목 | 핵심 |
|------|------|------|
| Ch.1 | 왜 CS를 공부해야 하는가 | CS를 모르면 키워드를 모르고, 키워드를 모르면 검색도 AI 활용도 못 한다 |
| Ch.2 | [로그를 뺐더니 빨라졌어요? (1)](ch02/README.md) | print문이 왜 느린지 - System Call과 커널 |
| Ch.3 | 로그를 뺐더니 빨라졌어요? (2) | CPU Bound와 I/O Bound, async의 오해 |
...
| 챕터 | 제목 | 핵심 |
|------|------|------|
| Ch.7 | AI가 코드를 짜주는 시대, 왜 CS를 알아야 하는가 | 프롬프트에 CS 키워드가 없으면 AI는 엉뚱한 방향으로 간다 |
| Ch.8 | AI에게 좋은 지시를 내리기 위한 CS 키워드 사전 | 카테고리별 핵심 키워드 |
| Ch.9 | AI가 만든 코드 리뷰하기 | CS 관점 코드 리뷰 체크리스트 |
