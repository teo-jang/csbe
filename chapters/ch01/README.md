...
첫 번째 챕터에서는 코드를 치지 않는다. 벤치마크도 없다. 대신 "왜 CS를 알아야 하는가"를 사례와 에피소드로 보여주고, 이 강의가 어떤 방식으로 진행되는지를 소개한다.
...
1. [JD와 이해, 그리고 경험](./01-why-cs.md)
2. [CS를 외워온다, 그리고 코딩과 CS](./02-cs-and-coding.md)
3. [어떻게 공부할 것인가](./03-how-to-learn.md)
4. [커리큘럼과 키워드 정리](./04-summary.md)

---

다음: [JD와 이해, 그리고 경험 >](./01-why-cs.md)
